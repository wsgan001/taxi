...
import com.geo.taxi.recommender.AbstractNode;
...
//		System.out.println("Creating new Node at depth " + depth);
	}
...
//		System.out.println("Coordinate [" + coordinates.x + "-" + coordinates.y
//				+ "] is within " + index.toString() + " at depth " + depth);
		return index;
	}
...
//			System.out.println("Inserting into existing cell: " + index);
		...
		if (!(this.depth >= maxDepth) && this.elements.size() > maxElements) {
			...
			// subnodes
			this.numElements = this.numElements - this.elements.size();
			this.elements.clear();
